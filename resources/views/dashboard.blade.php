                        ...
                        <div class="col-12 col-md-6 p-2">
                            ...
                            @elseif($isrent == true && $approved_rent == false)
                                <div class="border text-success d-flex justify-content-center align-items-center gap-3 rounded p-3">
                                    <div class="col p-1">
                                        <p>
                                            Application received. Please wait for verification and check your email regularly.
                                        </p>
                                    </div>
                                </div>
                  ...
                  <div class="row mt-5">
                        <div class="responsive-table col-12">
                            <h3 class="py-3 fs-6 d-flex justify-content-between">
                                ...
                                <form action="{{ route('deleteSms', ['user_id' => Auth::id()]) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                                    ...
                                    <tbody id="received-sms-body">
                                        @forelse($received_sms as $index => $sms)
                                            <tr id="sms-{{ $sms->id }}">
                                                ...
                                                <td>{{ $sms->created_at->format('Y-m-d') }}</td>
                                                <td>{{ $sms->created_at->format('H:i') }}</td>
                                            </tr>
                                        @empty
                                            <tr>
                        ...
                        <div class="modal-dialog">
                            ...
                            <form action="{{ route('sendSms') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control" id="recipient" name="recipient" maxlength="11" placeholder="09xxxxxxxxx" required>
                                    @error('recipient')
