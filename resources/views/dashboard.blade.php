                   ...
                   <div class="row">
                    <div class="col-12 col-md-6 p-2">
                        <div class="border d-flex justify-content-center align-items-center gap-2 rounded p-3">
                            <div class="d-flex justify-content-center align-items-center gap-2 bg-danger border rounded p-3">
                                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-send text-light" viewBox="0 0 16 16">
